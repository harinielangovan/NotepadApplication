...
{
    QMessageBox::about(this, tr("About MDI"),tr("Qt Creator is a cross-platform integrated development environment (IDE) built for the maximum developer experience."));
}
